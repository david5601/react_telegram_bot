    ...
    return (
        <div className='bar'>
            <ul className='bar__list'>
                ...
                <li>
                    <Link to="/wallets" className='bar_link'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-wallet-fill" viewBox="0 0 16 16">
                ...
                <li>
                    <Link to="/friends" className='bar_link'>
                ...
                <li>
                    <Link to="/tasks" className='bar_link'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bookmark-star-fill" viewBox="0 0 16 16">
